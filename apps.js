...
const appData = [
    ...
    { title: "AI", apps: [
        ...
        createApp({ name: "Ollama", description: "让用户在自己的设备上轻松运行和管理大型语言模型", link: "https://lmstudio.ai/", icon: "./images/ollama.png" }),
        createApp({ name: "LM Studio", description: "让你在本地运行和管理大型语言模型", link: "https://ollama.com/", icon: "./images/lmstudio_ai_logo.jpeg" }),
