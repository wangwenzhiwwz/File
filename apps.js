...
const appData = [
    ...
    { title: "AI", apps: [
        ...
        createApp({ name: "Microsoft Copilot", description: "Microsoft Copilot is your companion to inform and inspire.", link: "https://github.com/copilot/", icon: "./images/Copilot.png" }),
