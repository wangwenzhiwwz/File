...
const appData = [
    ...
    { title: "VPS", apps: [
        ...
        createApp({ name: "X-UI", description: "An Advanced Web Panel • Built on Xray Core", link: "https://xui.wwz.im/Wang/", icon: "./images/3x-ui-light.png" }),
    ...
    { title: "Other", apps: [
        ...
        createApp({ name: "V2raySE", description: "Online V2ray node conversion tool", link: "https://v2.v2rayse.com/node-convert/", icon: "./images/v2rayse.png" }),
