...
const appData = [
    { title: "Web", apps: [
        ...
        createApp({ name: "Zoho Mail", description: "Host your business email on a secure", link: "https://mail.zoho.eu/", icon: "./images/Zoho-Mail.png" }),
    ...
    { title: "Other", apps: [
        ...
        createApp({ name: "OpenWRT固件生成", description: "定制适用于您设备的OpenWrt固件", link: "https://openwrt.ai/?target=mediatek%2Ffilogic&id=cudy_tr3000-mod", icon: "./images/openwrt.png" }),
