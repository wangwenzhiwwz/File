...
const appData = [
    { title: "Web", apps: [
        ...
        createApp({ name: "Translate", description: "内网在线翻译", link: "https://p.wwz.im/https://translate.google.com/", icon: "./images/Google_Translate.png" }),
        createApp({ name: "新片场", description: "发现全球优质创作人", link: "https://www.xinpianchang.com/", icon: "./images/xinpianchang.jpg" }),
        createApp({ name: "ZCool", description: "打开站酷发现更好的设计", link: "https://www.zcool.com.cn/", icon: "./images/Zcool.png" }),
        createApp({ name: "TuChong", description: "展示摄影作品", link: "https://wangwenzhi.tuchong.com/videos/", icon: "./images/tuchong.jpg" }),
        createApp({ name: "Behance", description: "Adobe的全球创意社区", link: "https://www.behance.net/", icon: "./images/behance.png" }),
        createApp({ name: "GitHub", description: "Git代码托管和协作开发平台", link: "https://github.com/", icon: "./images/github.png" }),
        createApp({ name: "Vercel", description: "前端项目部署云平台", link: "https://vercel.com/", icon: "./images/vercel.png" }),
        createApp({ name: "Ping", description: "网站测速工具", link: "https://ping.chinaz.com/", icon: "./images/ChinaZ.png" }),
        createApp({ name: "Cloudflare", description: "网站加速安全防护", link: "https://dash.cloudflare.com/", icon: "./images/cloudflare.svg" }),
        createApp({ name: "Teambition", description: "企业级团队协作", link: "https://www.teambition.com/organization/61ade96d461f91c76e3bfc06/task/shortcut/66d920b8e2a3f00f0ddca2e3/", icon: "./images/Teambition.jpg" }),
        createApp({ name: "Notion", description: "多功能生产力应用", link: "https://www.notion.so/", icon: "./images/notion.webp" }),
        createApp({ name: "Milanote", description: "视觉化项目管理", link: "https://app.milanote.com/", icon: "./images/milanote.jpg" }),
        createApp({ name: "Whimsical", description: "统一的工作空间", link: "https://whimsical.com/", icon: "./images/whimsical.jfif" }),
        createApp({ name: "Artlist", description: "数字资产订阅", link: "https://artlist.io/", icon: "./images/artlist.png" }),
        createApp({ name: "闪电分镜", description: "高效的前期策划", link: "https://web.mediastory.cc/", icon: "./images/SDFJ.webp" }),
        createApp({ name: "Nodeseek", description: "热爱Web开发社区", link: "https://www.nodeseek.com/", icon: "./images/NodeSeek.png" }),
        createApp({ name: "V2EX", description: "创意工作者的社区", link: "https://p.wwz.im/https://www.v2ex.com/", icon: "./images/v2ex.jpeg" }),
        createApp({ name: "Alist", description: "存储文件列表", link: "https://alist.wwz.im/", icon: "./images/alist.png" }),
    ...
    { title: "AI", apps: [
        ...
        createApp({ name: "LM Studio", description: "让你在本地运行和管理大型语言模型", link: "https://lmstudio.ai/", icon: "./images/lmstudio_ai_logo.jpeg" }),
